...
<template>
  <div class="m-8 mb-4 md:ml-0 md:mt-16" :class="about ? 'md:col-span-3' : 'hidden'">
    <div :class="{ 'animate-text_animation': !about_animation }"><AboutText /><Career /></div>
  </div>
  <div
    class="m-8 mb-4 md:ml-0 md:mt-16 md:col-span-1"
    :class="{ hidden: about }"
  ...
  <div class="m-8 mt-0 md:m-16 md:ml-4" :class="about ? 'hidden' : 'md:col-span-3'">
    <div :class="{ 'animate-text_animation': about_animation }"><Skills /></div>
  </div>
  <div
    class="m-8 mb-4 md:ml-0 md:mt-16 md:col-span-1"
    :class="{ hidden: !about }"
